...
- (void) surveyQuestionsSyncNoInternetFound {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Error contacting server, please check your internet connection" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles: nil];
    [alert show];
}
